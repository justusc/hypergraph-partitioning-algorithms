#ifndef HGPA_DEFS_INCLUDED
#define HGPA_DEFS_INCLUDED
...
typedef struct hypergraph_st {
    ...
    cells_t *cells;        /* cells array */
    nets_t *nets;          /* nets array */
    corn_t *cnets;         /* cells of nets */
    corn_t *ncells;        /* nets of cells */
} hypergraph_t;
